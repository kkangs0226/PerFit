...
class _AddJobPageState extends State<AddJobPage> {
  ...
  bool _addJobFailed = false;
  bool _workingScheduleEmpty = false;
        ...
        child: Form(
          ...
          child: Column(
            children: <Widget>[
              ...
              if (_addJobFailed)
                Text(
                  '  Adding job unsucessful\nPlease refer to above fields ',
                  style: TextStyle(color: Colors.red),
                ),
              if (_workingScheduleEmpty)
                Text(
                  '           Please ensure at least\none working schedule is selected ',
                  style: TextStyle(color: Colors.red),
                ),
              if (_dynamicFieldEmpty)
                Text(
