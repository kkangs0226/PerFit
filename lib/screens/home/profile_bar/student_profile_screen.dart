...
class StudentProfileScreen extends StatefulWidget {
  ...
  StudentProfileScreen(this.currentUser);
    ...
    return Padding(
      ...
      child: ListView(
        children: <Widget>[
          Row(
            children: <Widget>[
              CircleAvatar(
                ...
                child: CircleAvatar(
                  backgroundImage: widget.currentUser['profile_image'] != null
                      ? NetworkImage(
          ...
          _buildDetails(
              'About: ', '${widget.currentUser['short_description']}', context),
          _buildDetails('Gender: ', '${widget.currentUser['gender']}', context),
          _buildDetails('School: ', '${widget.currentUser['school']}', context),
          _buildDetails('Year of study: ',
              '${widget.currentUser['year_of_study']}', context),
          _buildDetails(
              'Faculty: ', '${widget.currentUser['faculty']}', context),
          _buildDetails('Course: ', '${widget.currentUser['course']}', context),
