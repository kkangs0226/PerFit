...
class EmployerProfileScreen extends StatefulWidget {
  ...
  EmployerProfileScreen(this.currentUser);
    ...
    return Padding(
      ...
      child: ListView(
        children: <Widget>[
              ...
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      widget.currentUser['company_registration_number'] != null
          ...
          _buildDetails(
              'About: ', '${widget.currentUser['about_company']}', context),
          _buildDetails('Address : ',
              '${widget.currentUser['company_address']}', context),
          _buildDetails(
              'Founder\'s name: ', '${widget.currentUser['name']}', context),
